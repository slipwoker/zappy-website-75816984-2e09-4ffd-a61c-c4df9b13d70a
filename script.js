document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFieldError(field, message) {
    ...
    field.addEventListener('input', function clearError() {
      ...
      const msg = parent ? parent.querySelector('.form-error-message') : null;
      if (msg) msg.remove();
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Simvestrix משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '75816984-2e09-4ffd-a61c-c4df9b13d70a',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '75816984-2e09-4ffd-a61c-c4df9b13d70a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '75816984-2e09-4ffd-a61c-c4df9b13d70a';
